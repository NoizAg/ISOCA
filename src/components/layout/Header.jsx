  ...
  return (
    <header className="sticky top-0 z-50 bg-white/95 backdrop-blur-md shadow-lg border-b border-gray-100">
      <div className="container mx-auto flex items-center justify-between py-4 px-6">
        ...
        <button
          className="lg:hidden flex flex-col justify-center items-center w-10 h-10 focus:outline-none focus:ring-2 focus:ring-green-500 rounded-lg"
        ...
        >
          ...
          <span className={`block w-6 h-0.5 bg-gray-700 mb-1 transition-all duration-300 ${mobileOpen ? 'opacity-0' : 'opacity-100'}`}></span>
      ...
      {/* Mobile menu drawer */}
      <nav
        className={`fixed top-0 right-0 h-full w-80 bg-grey shadow-2xl z-50 transform transition-transform duration-300 ease-in-out ${mobileOpen ? 'translate-x-0' : 'translate-x-full'} lg:hidden`}
